...
export function MTableToolbarWithZustand(props) {
  ...
  const state = useToolbar((state) => state);
  ...
  function renderSearch() {
    const localization = {
      ...MTableToolbarWithZustand.defaultProps.localization,
      ...props.localization
    };
    if (props.search) {
      return (
          ...
          <span>
            <Tooltip title={localization.showColumnsTitle}>
              <IconButton
                color="inherit"
                onClick={
                  (event) => state.setColumnsButtonAnchorEl(event.currentTarget)
                  // setState({
                  //   ...state,
            ...
            <Menu
              ...
              onClose={
                () => state.setColumnsButtonAnchorEl(null)
          ...
          <span>
            <Tooltip title={localization.exportTitle}>
              <IconButton
                color="inherit"
                onClick={
                  (event) => state.setExportButtonAnchorEl(event.currentTarget)
                  // setState({
                  //   ...state,
            ...
            <Menu
              ...
              onClose={
                () => state.setExportButtonAnchorEl(null)
...
MTableToolbarWithZustand.defaultProps = {
  actions: [],
  columns: [],
...
MTableToolbarWithZustand.propTypes = {
...
const MTableToolbarWithZustandRef = React.forwardRef(
  function MTableToolbarWithZustandRef(props, ref) {
    return <MTableToolbarWithZustand {...props} forwardedRef={ref} />;
  }
);

export default withStyles(styles)(MTableToolbarWithZustandRef);
